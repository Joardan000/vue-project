          ...
          >
            ...
            >
              <div
                  ...
                  :key="index"
                  class="group p-6 rounded-2xl bg-slate-800/20 backdrop-blur-xl border border-slate-700/30 hover:bg-slate-800/40 hover:border-indigo-600/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] hover:scale-105"
              >
                <div
            ...
            <div
              ...
              <div
                  class="relative rounded-3xl overflow-hidden border border-slate-800/50 bg-gradient-to-br from-slate-900/40 to-indigo-950/30 backdrop-blur-2xl shadow-[0_0_50px_rgba(99,102,241,0.2)] group hover:shadow-[0_0_80px_rgba(139,92,246,0.4)] transition-all duration-500">
                <div
