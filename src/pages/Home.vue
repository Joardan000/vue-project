...
async function getData() {
  try{
    loading.value = true
    const res = await customApi.get(`/Groups?Limit=${limit.value}&Offset=${offset.value}`,{
      headers: {
...
<!--    &lt;!&ndash; Premium Animated Glass Background &ndash;&gt;-->
<!--    <div class="fixed inset-0 overflow-hidden pointer-events-none">-->
<!--      &lt;!&ndash; Animated Gradient Mesh &ndash;&gt;-->
<!--      <div class="absolute inset-0">-->
<!--        &lt;!&ndash; Main Gradient Orbs with Parallax &ndash;&gt;-->
<!--        <div-->
...
<!--        &lt;!&ndash; Secondary Gradient Layers &ndash;&gt;-->
<!--        <div-->
...
<!--      &lt;!&ndash; Floating Glass Panels &ndash;&gt;-->
<!--      <div class="absolute inset-0">-->
<!--        <div-->
...
<!--      &lt;!&ndash; Animated Particles &ndash;&gt;-->
<!--      <div class="absolute inset-0">-->
<!--        <div-->
...
<!--      &lt;!&ndash; Grid Pattern Overlay &ndash;&gt;-->
<!--      <div-->
...
<!--      <Header navbar1="Bosh Sahifa" navbar2="Xizmatlar" navbar3="Portfolio" navbar4="Jamoa"/>-->
...
<!--            &lt;!&ndash; Interactive Showcase Card &ndash;&gt;-->
<!--            <div-->
